...
contract RAINBOW is ERC1155 {
    ...
    // https://gateway.pinata.cloud/ipfs/QmW2Dk24dWsxXdxzYexoekSva3hZmFKTasXVsCSEyiWw41
    ...
    function getBatchAddress(uint a) public view returns(address[] memory) {
    ...
    function getbalanceOfBatch(uint[] memory _tokenIds) public view returns(uint[] memory) {
        return balanceOfBatch(getBatchAddress(_tokenIds.length), _tokenIds);
    }
}
